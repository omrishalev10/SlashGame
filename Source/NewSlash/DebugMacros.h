...
#define DRAW_SPHERE2(Location, Color) if (GetWorld()) DrawDebugSphere(GetWorld(), Location, 25.f, 12, Color, true);
#define DRAW_CAPSULE(Location) if (GetWorld()) DrawDebugCapsule(GetWorld(), Location, 25.f, 12, FQuat::Identity, FColor::Black);


/* Draw for Single Frames */
